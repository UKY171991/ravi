...
<section id="hero" class="hero-section bg-primary text-white py-5">
    <div class="container">
        <div class="row align-items-center min-vh-100">
            <div class="col-lg-6">
                <div class="hero-content">
                    <span class="badge bg-light text-primary mb-3 fs-6 px-3 py-2">WE PROVIDE 100% & TRUSTABLE</span>
                    <h1 class="display-3 fw-bold mb-4">IT<br>Solution</h1>
                    <p class="lead mb-4">We provide the most responsive and functional IT design for companies and businesses worldwide.</p>
                    
                    <div class="hero-buttons mb-5">
                        <a href="<?php echo home_url('/about-us'); ?>" class="btn btn-light btn-lg me-3 px-4">Read More</a>
                        <a href="https://www.youtube.com/watch?v=MLpWrANjFbI&ab_channel=eidelchteinadvogados" class="btn btn-outline-light btn-lg" target="_blank">
                            <i class="fas fa-play me-2"></i>Watch Video
                        </a>
                    </div>
                    ...
                    <!-- Service Links -->
                    <div class="hero-services mb-4">
                        <a href="#" class="btn btn-outline-light btn-sm me-2 mb-2">Highly professional IT experts</a>
                        <a href="#" class="btn btn-outline-light btn-sm me-2 mb-2">Infrastructure Technology</a>
                        <a href="#" class="btn btn-outline-light btn-sm me-2 mb-2">Quality Control System</a>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center mb-5">
                ...
                <p class="section-subtitle">Professional IT solutions for your business needs</p>
            </div>
        </div>
        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                <div class="service-card h-100 p-4 border rounded-3 text-center">
                    <div class="service-icon mb-3">
                        <i class="fas fa-server fa-3x text-primary"></i>
                    </div>
                    <h4>Infrastructure Technology</h4>
                    <p>Complete infrastructure solutions for modern businesses with scalable and reliable technology.</p>
                    <a href="#" class="btn btn-outline-primary">Learn More</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-card h-100 p-4 border rounded-3 text-center">
                    ...
                    <p>Secure and innovative blockchain solutions for next-generation applications.</p>
                    <a href="#" class="btn btn-outline-primary">Learn More</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-card h-100 p-4 border rounded-3 text-center">
                    ...
                    <p>Cutting-edge technology solutions for growth and digital transformation.</p>
                    <a href="#" class="btn btn-outline-primary">Learn More</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-card h-100 p-4 border rounded-3 text-center">
                    ...
                    <p>Comprehensive data management and analytics solutions for better insights.</p>
                    <a href="#" class="btn btn-outline-primary">Learn More</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-card h-100 p-4 border rounded-3 text-center">
                    ...
                    <p>Enterprise-level security and protection against cyber threats.</p>
                    <a href="#" class="btn btn-outline-primary">Learn More</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-card h-100 p-4 border rounded-3 text-center">
                    ...
                    <h4>IT Experts</h4>
                    <p>Highly professional IT experts for your dedicated technology team.</p>
                    <a href="#" class="btn btn-outline-primary">Learn More</a>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center mb-5">
                ...
                <p class="section-subtitle">We provide exceptional IT solutions with proven expertise</p>
            </div>
        </div>
        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                <div class="feature-item text-center p-4">
                    ...
                    <p>Lightning-fast solutions for optimal business performance.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="feature-item text-center p-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="feature-item text-center p-4">
                    ...
                    <p>Guaranteed quality with industry-standard practices.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="testimonials-section py-5 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center mb-5">
                <h2 class="section-title fw-bold">What Our Clients Say</h2>
                <p class="section-subtitle">Testimonials from satisfied customers</p>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-8 mx-auto">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="testimonial-item text-center p-4">
                                <div class="testimonial-content mb-4">
                                    ...
                                    <p class="lead">"Excellent service and professional team. They delivered exactly what we needed for our IT infrastructure."</p>
                                </div>
                        ...
                        <div class="carousel-item">
                            <div class="testimonial-item text-center p-4">
                                <div class="testimonial-content mb-4">
                                    <i class="fas fa-quote-left fa-2x text-primary mb-3"></i>
                                    <p class="lead">"Outstanding support and innovative solutions. Highly recommend their services to any business."</p>
                                </div>
                                <div class="testimonial-author">
                                    <h5>Sarah Johnson</h5>
                                    <p class="text-muted">CTO, Digital Solutions</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section class="blog-section py-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center mb-5">
                <h2 class="section-title fw-bold">Latest Blog Posts</h2>
                <p class="section-subtitle">Stay updated with our latest insights and news</p>
            </div>
        </div>
        <div class="row g-4">
            <?php
            ...
            <div class="col-lg-4 col-md-6">
                <article class="blog-card h-100">
                    <div class="blog-image">
                        ...
                        <?php else : ?>
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about-image.png" 
                                 alt="<?php the_title(); ?>" class="img-fluid w-100">
                        <?php endif; ?>
                    </div>
            ...
            ?>
            <!-- Placeholder blog cards if no posts exist -->
            <div class="col-lg-4 col-md-6">
                <article class="blog-card h-100">
                    <div class="blog-image">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about-image.png" 
                             alt="Blog Post" class="img-fluid w-100">
                    </div>
                    <div class="blog-content p-4">
                        <div class="blog-meta mb-2">
                            <span class="text-muted">
                        ...
                        <h4><a href="#" class="text-decoration-none">Latest IT Trends 2025</a></h4>
                        <p>Discover the latest trends in information technology and how they can benefit your business.</p>
            ...
            <div class="col-lg-4 col-md-6">
                <article class="blog-card h-100">
                    ...
                    <div class="blog-content p-4">
                        ...
                        <h4><a href="#" class="text-decoration-none">Cloud Security Best Practices</a></h4>
                        <p>Learn about essential security measures for protecting your cloud infrastructure.</p>
                        <a href="#" class="btn btn-outline-primary">Read More</a>
                    </div>
                </article>
            </div>
            <div class="col-lg-4 col-md-6">
                <article class="blog-card h-100">
                    ...
                    <div class="blog-content p-4">
                        ...
                        <h4><a href="#" class="text-decoration-none">Digital Transformation Guide</a></h4>
                        <p>A comprehensive guide to successfully implementing digital transformation in your organization.</p>
                        <a href="#" class="btn btn-outline-primary">Read More</a>
                    </div>
                </article>
            </div>
...
<section class="newsletter-section py-5 bg-primary text-white">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h3 class="fw-bold mb-3">Subscribe to Our Newsletter</h3>
                <p>Stay updated with our latest news, tips, and exclusive offers.</p>
            </div>
            <div class="col-lg-6">
                <form class="newsletter-form" method="post">
                    <?php wp_nonce_field('newsletter_nonce', 'newsletter_nonce'); ?>
                    <div class="input-group">
                        <input type="email" name="newsletter_email" class="form-control form-control-lg" placeholder="Enter your email" required>
                        <button class="btn btn-light btn-lg" type="submit" name="newsletter_submit">
                            <i class="fas fa-paper-plane me-2"></i>Subscribe
                        </button>
                    </div>
                </form>
